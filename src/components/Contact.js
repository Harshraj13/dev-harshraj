...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let response = await fetch("https://nodemaileer.onrender.com/sendContactMail", {
      method: "POST",
      headers: {
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    </Col>
                    {
                      status.message &&
                      <Col>
                        <p className={status.success === false ? "danger mailsend" : "success mailsend"}>{status.message}</p>
                      </Col>
                    }
                  </Row>
                </form>
